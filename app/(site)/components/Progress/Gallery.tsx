    ...
    <main className="relative mx-auto w-full max-w-[1240px] px-6 pb-20 pt-6 md:pb-28 md:pt-10">
      ...
      <header className="mb-12 flex flex-col items-center text-center">
        ...
        <p className="mt-5 max-w-[540px] text-[15px] leading-relaxed text-fg/70">
          Quiet progress primitives for setup flows, dashboards, uploads, and
          long-running work.
        </p>
      </header>
...
function CodeBlock({
  ...
  return (
    <div className="relative">
      ...
      <div
        className={`min-w-0 overflow-x-auto overflow-y-auto rounded-lg bg-[#0d1117] p-4 pr-20 font-mono text-[11px] leading-relaxed text-gray-300 ${expanded ? "max-h-[520px]" : "max-h-[150px]"}`}
      >
        {isHtml ? (
          <div

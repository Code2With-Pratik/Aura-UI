      ...
      <div className="radial-menu-container">
        ...
        >
          ...
          <path
            ...
            d="M 200 150 Q 200 82, 200 30"
          />
          <path
            pathLength={1}
            className="line line-2"
            d="M 200 150 Q 255 85, 304 66"
          />
          <path
            pathLength={1}
            className="line line-3"
            d="M 200 150 Q 275 150, 344 150"
          />
          <path
            pathLength={1}
            className="line line-4"
            d="M 200 150 Q 255 215, 304 234"
          />
          <path
            pathLength={1}
            className="line line-5"
            d="M 200 150 Q 200 220, 200 270"
          />
          <path
            pathLength={1}
            className="line line-6"
            d="M 200 150 Q 145 215, 96 234"
          />
          <path
            pathLength={1}
            className="line line-7"
            d="M 200 150 Q 125 150, 56 150"
          />
          <path
            pathLength={1}
            className="line line-8"
            d="M 200 150 Q 145 85, 96 66"
          />
        </svg>
        ...
        <div className="menu-item item-6">
          ...
          >
            ...
            >
              <path
                fill="#fafafa"
                d="M22.586,4.414L5.879,21.121C5.316,21.684,5,22.447,5,23.243V41c0,1.105,0.895,2,2,2h34 c1.105,0,2-0.895,2-2V23.243c0-0.796-0.316-1.559-0.879-2.121L25.414,4.414C24.633,3.633,23.367,3.633,22.586,4.414z"
              />
              <path fill="#43a047" d="M12 35H36V43H12z" />
              <path fill="#fbc02d" d="M13,24v19H7c-1.1,0-2-0.9-2-2V24H13z" />
              <path
                fill="#1e88e5"
                d="M42.12,21.12L29.59,8.59l-5.55,5.55L35,25.1V43h6c1.1,0,2-0.9,2-2V23.24 C43,22.45,42.68,21.68,42.12,21.12z"
              />
              <path
                fill="#e64a19"
                d="M29.59,8.59L5,33.18v-9.94c0-0.79,0.32-1.56,0.88-2.12L22.59,4.41c0.78-0.78,2.04-0.78,2.82,0 L29.59,8.59z"
              />
            </svg>
          </button>
        </div>
...
const StyledWrapper = styled.div`
  ...
  .menu-toggle:checked ~ .center-icon {

...
export default function Input9() {
  return (
    <>
...
const styles = `
  ...
  .ai-input-container .ai-svg path {
    transform-box: fill-box;
    transform-origin: center;
  }

  .ai-input-container:is(:hover, :focus-within) .ai-svg path {
    animation: pop 0.5s var(--d);
  }

  .ai-input-container .ai-svg path:nth-of-type(1) {
    --d: 0.24s;
    --r: 20deg;
    --s: 1.5;
  }
  .ai-input-container .ai-svg path:nth-of-type(2) {
    --d: 0.12s;
    --r: 10deg;
    --s: 1.4;
  }
  .ai-input-container .ai-svg path:nth-of-type(3) {
    --d: 0s;
    --r: 0deg;
    --s: 1.25;
  }
  ...
  .ai-search-input {
    ...
    min-width: 200px;
    width: 100%;
    padding: 0.8rem 0.8rem 0.8rem calc(0.8rem + var(--icon-size) + 0.4rem);
    font-size: 0.95rem;
    background:

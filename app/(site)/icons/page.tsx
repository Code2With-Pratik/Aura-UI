      ...
      <header className="mb-16 flex flex-wrap items-end justify-between gap-6">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-pretty text-base leading-relaxed text-fg/60">
            One stroke weight (1.4px), rounded caps and joins, optical alignment to a 16-unit grid. Designed to sit
            inside Aura UI without ever pulling focus.
          </p>
        </div>
        <div className="flex items-center gap-3 font-mono text-xs text-fg/40">
